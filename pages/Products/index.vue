    ...
    <div class="columns category-header">
      <div class="column main-column is-tablet-landscape-padded">
        ...
        <div class="listing-controls">
          ...
          <button v-on:click="toggleModal" class="button is-success is-outlined">+ Add Product</button>
          <div class="modal" :class="{'is-active': showModal}">
            ...
            <div class="modal-card">
              ...
              <footer class="modal-card-foot">
                <button v-on:click="createProduct" class="button is-success">Add</button>
        ...
        <div class="columns is-product-list is-multiline spacer">
          <div class="column is-10">
            <ul>
              <li class="list-view" v-for=" product in products" :key="product.id">
                <div class="columns">
                    ...
                    <div class="dropdown is-hoverable is-right pull-right">
                      ...
                      <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                        <div class="dropdown-content">
                          ...
                          <div class="dropdown-item">
                            <a v-on:click="deleteProduct(product.id)">Delete</a>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async deleteProduct(id: string) {
      let r = await axios.delete('products/' + id)
    },
    async createProduct() {
      const p = {
        title: this.title,
      ...
      let result = await axios.post('products', p)
      if (result.data.id) {
        this.toggleModal()
      }
      return null
